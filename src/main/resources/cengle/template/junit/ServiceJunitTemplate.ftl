package ${bussPackage}.servicetest;
...
import ${bussPackage}.service.I${className}${Cname}Service;
...
@Transactional
public class ${className}${Cname}ServiceTest {
	private static Object id;
	@Autowired
	private I${className}${Cname}Service $!{lowerName}Service;
